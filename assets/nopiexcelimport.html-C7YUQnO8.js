import{_ as n}from"./plugin-vue_export-helper-DlAUqK2U.js";import{c as t,e as l,o}from"./app-BJhRIsgW.js";const a={};function r(i,e){return o(),t("div",null,e[0]||(e[0]=[l(`<h2 id="使用nopi导入excel文档" tabindex="-1"><a class="header-anchor" href="#使用nopi导入excel文档"><span>使用NOPI导入Excel文档</span></a></h2><blockquote><p>NOPI版本：2.3.0,依赖于NPOI的SharpZipLib版本：0.86,经测试适用于.net4.0+</p></blockquote><h2 id="记录遇到的几个问题" tabindex="-1"><a class="header-anchor" href="#记录遇到的几个问题"><span>记录遇到的几个问题</span></a></h2><ol><li><p>NOPI中的<code>IWorkbook</code>接口：xls使用<code>HSSFWorkbook</code>类实现，xlsx使用<code>XSSFWorkbook</code>类实现</p></li><li><p>日期转换，判断<code>row.GetCell(j).CellType == NPOI.SS.UserModel.CellType.Numeric &amp;&amp; HSSFDateUtil.IsCellDateFormatted(row.GetCell(j)</code></p></li></ol><p>不能直接使用<code>row.GetCell(j).DateCellValue</code>,这玩意会直接抛出异常来~</p><h3 id="_1-将文件流转换为datatable" tabindex="-1"><a class="header-anchor" href="#_1-将文件流转换为datatable"><span>1. 将文件流转换为DataTable</span></a></h3><pre><code>    /// &lt;summary&gt;
